...
import com.abasecode.opencode.base.safe.desensitize.DesensitizeTel;
 ...
 */
@MappedTypes(DesensitizeTel.class)
@Slf4j
@Component
public class DesensitizeTelHandler extends BaseTypeHandler<String> {
