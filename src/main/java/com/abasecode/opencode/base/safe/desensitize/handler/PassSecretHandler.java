...
import com.abasecode.opencode.base.safe.desensitize.PassSecret;
 ...
 */
@MappedTypes(PassSecret.class)
@Slf4j
@Component
public class PassSecretHandler extends BaseTypeHandler<String> {
    @Autowired
    ...
    public String getNullableResult(ResultSet resultSet, String s) throws SQLException {
        ...
        try{
            ...
            System.out.println("密码解密"+e.getMessage());
        }
        return s1;
    }
